    ...
    <div id="schedule" class="w-4/5 mt-24">
        ...
        <ol class="relative border-s border-blue-800 dark:border-gray-700">                  
            <li  v-for="(events, hour) in schedules" :key="hour" class="ms-4 font-kiwi">
                <div class="absolute w-3 h-3 bg-blue-800 rounded-full mt-1.5 -start-1.5 border-3 border-blue-800 dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-blue-800 dark:text-gray-500">{{ hour }}</time>
