    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white/40 backdrop-blur-xl rounded-lg shadow-sm ">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-blue-200">
                <div>
                    <h3 class="font-kiwi text-xl font-medium  text-blue-100 ">
                            {{ ScheduleEvent?.title }}
                    </h3>
                ...
                <button type="button" data-modal-hide="schedule-modle" class="text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-start items-center">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <p class="text-base leading-relaxed text-white font-kiwi" >
